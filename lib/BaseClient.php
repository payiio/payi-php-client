...
use BronosPay\Exception\Api\BadAuthToken;
use BronosPay\Exception\Api\BadRequest;
use BronosPay\Exception\Api\NotFound;
use BronosPay\Exception\Api\OrderIsNotValid;
use BronosPay\Exception\Api\OrderNotFound;
use BronosPay\Exception\Api\Unauthorized;
use BronosPay\Exception\Api\UnprocessableEntity;
use BronosPay\Exception\ApiErrorException;
use BronosPay\Exception\InvalidArgumentException;
use BronosPay\Exception\InternalServerError;
use BronosPay\Exception\RateLimitException;
use BronosPay\Exception\UnknownApiErrorException;
use BronosPay\HttpClient\ClientInterface as HttpClientInterface;
use BronosPay\HttpClient\CurlClient;
use BronosPay\Services\OrderService;
...
class BaseClient implements ClientInterface
{
     ...
     */
    public const DEFAULT_API_BASE = 'http://127.0.0.1:9000';

    /**
     * @var string default base URL for CoinBase's API
     */
    public const SANDBOX_DEFAULT_API_BASE = 'http://127.0.01:9000';
    ...
    /**
     * Initializes a new instance of BronosPay's BaseClient class.
     *
    ...
    /**
     * Gets the base URL for BronosPay's API.
     *
     * @return string
     */
    ...
    /**
     * Gets the environment used to interact with BronosPay's API.
     *
     * @return string
     */
    ...
    protected function getDefaultHeaders(string $method): array
    {
        ...
        if (($appInfo = self::getAppInfo()) !== null) {
            $headers[] = 'User-Agent: BronosPay/v1 (PHP Library v' . self::VERSION . ', '
    ...
    /**
     * Send a request to BronosPay API.
     *
