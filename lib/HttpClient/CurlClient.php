...
use BronosPay\Exception\ApiConnectionException;
use BronosPay\Exception\UnexpectedValueException;
    ...
    private function handleCurlError(string $url, int $errno, string $message)
    {
        switch ($errno) {
            ...
            case CURLE_OPERATION_TIMEOUTED:
                $response = "Could not connect to BronosPay ($url). "
            ...
            case CURLE_SSL_PEER_CERTIFICATE:
                $response = "Could not verify BronosPay's SSL certificate. "
            ...
            default:
                $response = "Unexpected error communicating with BronosPay. ";
        }

        $response .= 'If this problem persists, let us know at https://support.bronos.org.';
